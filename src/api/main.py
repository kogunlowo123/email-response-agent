"""Email Response Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Email support agent that classifies inbound support emails, generates contextual draft responses, prioritizes by urgency, routes to specialists, and tracks resolution metrics.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
